...
const HomePage = () => {
    return (
        ...
        <div className="flex flex-col items-center px-5 pt-8 pb-20 text-2xl font-medium bg-white text-stone-800">
          <div className="self-stretch text-4xl font-bold text-yellow-900">
            Java Joy
          </div>
          <div className="shrink-0 mt-14 w-8 h-8 bg-zinc-300 max-md:mt-10" />
          <div className="mt-3 font-bold">Home</div>
          <div className="shrink-0 mt-8 w-8 h-8 bg-zinc-300" />
          <div className="mt-3">Menu</div>
          <div className="shrink-0 mt-8 w-8 h-8 bg-zinc-300" />
          <div className="mt-3">History</div>
          <div className="shrink-0 mt-7 w-8 h-8 bg-zinc-300" />
          <div className="mt-3">Staff</div>
          <div className="shrink-0 mt-8 w-8 h-8 bg-zinc-300" />
          <div className="mt-3">Inventory</div>
          <div className="shrink-0 mt-7 w-8 h-8 bg-zinc-300" />
          <div className="mt-3">Analytics</div>
          <div className="shrink-0 mt-7 w-8 h-8 bg-zinc-300" />
          <div className="mt-3">Reservation</div>
          <div className="shrink-0 mt-8 w-8 h-8 bg-zinc-300" />
          <div className="mt-3">Settings</div>
          <div className="shrink-0 mt-9 w-8 h-8 bg-zinc-300" />
          <div className="mt-3">Log out</div>
        </div>
